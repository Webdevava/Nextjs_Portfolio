                ...
                <AnimatedDiv>
                    <div className="p-4 flex flex-col border-2 border-ring rounded-lg bg-gradient ">
                        ...
                        <form
                            ...
                            className="p-4 flex flex-col gap-4 border-2 border-ring rounded-lg bg-secondary"
                        >
                            <input
                                type="text"
                                name="title"
                                ...
                                className=" border-2 border-ring p-2 text-lg rounded-md bg-background"
                            ...
                            <textarea
                                ...
                                className="bg-background border-2 border-ring p-2 text-lg rounded-md"
                                onChange={handleChange}
                            />
                            <input
                                type="text"
                            ...
                            <input
                                type="submit"
                                className="submitBtn bg-card border-2 border-ring p-2 text-lg rounded-md hover:bg-primary/50  cursor-pointer mt-4"
                            />
                        </form>
                    </div>
                </AnimatedDiv>
