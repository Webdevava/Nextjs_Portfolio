...
const LetsConnect = () => {
  return (
    ...
    <Link href="/contact" className="px-4 py-8 border-2 border-primary bg-gradient  relative w-2/3 lg:w-1/2 connectBtn border-r-0 rounded-s-lg flex justify-start items-center">
